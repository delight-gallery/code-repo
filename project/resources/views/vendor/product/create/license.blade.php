...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">License Product <a class="add-btn" href="{{ route('vendor-prod-types') }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('vendor-prod-types') }}">Add Product</a>
												</li>
												<li>
													<a href="{{ route('vendor-prod-license-create') }}">License Product</a>
												</li>
											</ul>
									</div>
								</div>
				...
				<i class="icofont-upload-alt"></i> Upload Image Here
												...
												<div class="row">
												  ...
												  <div class="row">
													...
													<div class="col-lg-7">
														<input name="tax" type="text" class="input-field" placeholder="20%"  required="">
													</div>
												</div>		
									                                ...
									                                <span class="remove license-remove"><i class="fas fa-times"></i></span>
									                                    <div  class="row">
									                                       <div class="col-lg-6">
									                                        ...
									                                        <div class="col-lg-6">
									                                           <input type="number" min="1" name="license_qty[]" class="input-field" placeholder="License Quantity" value="1">
									                                        </div>
									                                   </div>
									                            </div>
															</div>
                                       ...
                                       <div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Platform" name="platform">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Region" name="region">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Type" name="licence_type">
													</div>
												</div>
