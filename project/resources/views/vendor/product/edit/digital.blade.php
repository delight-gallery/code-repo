...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"> Edit Product<a class="add-btn" href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
											<ul class="links">
												<li>
													<a href="{{ route('vendor-dashboard') }}">Dashboard </a>
												</li>
												<li>
													<a href="{{ route('vendor-prod-index') }}">Products </a>
												</li>
												<li>
													<a href="javascript:;">Physical Product</a>
												</li>
												<li>
													<a href="{{ route('vendor-prod-edit',$data->id) }}">Edit</a>
												</li>
											</ul>
									</div>
								</div>
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> Upload Image Here
                                               ...
                                               <div class="row">
													...
													<div class="col-lg-7">
														<input  name="delivery_date" type="text" class="input-field datepicker" placeholder="Enter Delivery Date"  value="{{$data->delivery_date}}"> 
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
