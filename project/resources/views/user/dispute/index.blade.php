					...
					<div class="user-profile-details">
						<div class="order-history">
							<div class="header-area">
								<h4 class="title">
									Disputes <a data-toggle="modal" data-target="#vendorform" class="mybtn1" href="javascript:;"> <i class="fas fa-envelope"></i> Add Dispute</a>
								</h4>
							</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="vendorformLabel">Add Dispute</h5>
            ...
            <div class="col-md-12">
              <div class="contact-form">
                <form id="emailreply1">
                  ...
                  <ul>
                    <li>
                      <input type="text" class="input-field" id="order" name="order_numkber" placeholder="Order Number *" required="">
                    </li>
                  ...
                  <button class="submit-btn" id="emlsub1" type="submit">Send</button>
                </form>
              </div>
            </div>
          </div>
    ...
    <div class="modal-header d-block text-center">
        <h4 class="modal-title d-inline-block">Confirm Delete</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
            <p class="text-center">You are about to delete this Dispute.</p>
