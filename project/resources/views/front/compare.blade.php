									...
									<tbody>
										<tr>
											...
											<td class="product-image-title c{{$product['item']['id']}}">
													...
													<img class="img-fluid" src="{{ $product['item']['photo'] ? asset('assets/images/products/'.$product['item']['photo']):asset('assets/images/noimage.png') }}" alt="Compare product['item']">
										...
										<tr>
											...
											<tr>
													...
													@foreach($products as $product)
													<td class="c{{$product['item']['id']}}"><a href="javascript:;" data-href="{{ route('product.cart.add',$product['item']['id']) }}" class="btn__bg add-to-cart">{{ $langg->lang75 }}</a></td>
													@endforeach
												</tr>
										<tr>
