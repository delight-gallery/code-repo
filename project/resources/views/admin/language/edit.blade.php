                    ...
                    <div class="product-description">
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang222" placeholder="Profile" required="" value="{{ $lang->lang222 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang15" placeholder="More Categories" required="" value="{{ $lang->lang15 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang16" placeholder="Less Categories" required="" value="{{ $lang->lang16 }}">
                          </div>
                        </div>
                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang202" placeholder="Affilate Code" required="" value="{{ $lang->lang202 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang215" placeholder="Affilate Bonus" required="" value="{{ $lang->lang215 }}">
                          </div>
                        </div>
