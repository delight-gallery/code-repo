...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">License Product <a class="add-btn" href="{{ route('admin-prod-types') }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('admin-prod-license-create') }}">License Product</a>
												</li>
											</ul>
									</div>
								</div>
