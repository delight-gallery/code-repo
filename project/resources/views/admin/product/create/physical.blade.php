...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">Physical Product <a class="add-btn" href="{{ route('admin-prod-types') }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('admin-prod-physical-create') }}">Physical Product</a>
												</li>
											</ul>
									</div>
								</div>
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> Upload Image Here
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																...
																<label for="check1">Enter Expected delivery Time</label>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Estimated Delivery Time* </h4>
														</div>
													</div>
													<div class="col-lg-7">
											...
											<div class="showbox">
                                         	...
                                         	<div class="row">
													...
													<div class="col-lg-7">
														<input  name="cancel_hr" type="text" class="input-field datepicker" placeholder="Enter Delivery Date" required>
													</div>
												</div>
													...
													<div class="col-lg-7">
														<input  name="return_date" type="text" class="input-field datepicker" placeholder="Enter Delivery Date" required>
													</div>
												</div>
