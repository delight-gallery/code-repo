								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks {{ $gs->is_faq == 1 ? 'drop-success' : 'drop-danger' }}">
	                                      <option data-val="1" value="{{route('admin-gs-isfaq',1)}}" {{ $gs->is_faq == 1 ? 'selected' : '' }}>Activated</option>
	                                      <option data-val="0" value="{{route('admin-gs-isfaq',0)}}" {{ $gs->is_faq == 0 ? 'selected' : '' }}>Deactivated</option>
	                                    </select>
	                                  </div>
								</div>
									<div class="mr-table allproduct">
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        <th width="200px">Faq Title</th>
									                        <th width="300px">Faq Details</th>
									                        <th>Actions</th>
														</tr>
													</thead>
												</table>
