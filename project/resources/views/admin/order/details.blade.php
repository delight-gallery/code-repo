...
@section('content')
    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">Order Details <a class="add-btn" href="javascript:history.back();"><i class="fas fa-arrow-left"></i> Back</a></h4>
                                        <ul class="links">
                                            <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <select name="" class="process select order-droplinks {{ strtolower($order->status) }}">
