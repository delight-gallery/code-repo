...
Route::get('/BuyOffline/customer/{id?}', 'Admin\BuyOfflineController@getCustomer')->name('admin-get-customer');  
...
Route::post('/frond/checkPincode','Front\FrontendController@checkPincode');

//Route::post('/catalog/checkPincode', 'Front\CatalogController@checkPincode');

Route::post('/callback', 'Front\PaymentController@callback')->name('customer.payment.callback');
